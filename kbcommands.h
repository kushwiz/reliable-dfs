...
enum ConnectionSignals {ADD_TO_SERVER_IP_LIST=11, REMOVE_FROM_SERVER_IP_LIST, GET_REPLY, PUT_SATNEY, SYNC_PEERS, ERR_MAXPEERS, ERR_FILENOTFOUND, ERR_INVALID, ERR_INVALID_CONNECT};
